...
- Terminar las escrituras PostgreSQL por agregado para retiros y moderación administrativa; creación, transiciones/cancelaciones, pago demo, mensajes, reseñas y altas de verificación ya no escriben el snapshot.
...
Siguiente paso: migrar los retiros demo y la moderación administrativa, que aún usan el adaptador transitorio de snapshot en el modo PostgreSQL.
